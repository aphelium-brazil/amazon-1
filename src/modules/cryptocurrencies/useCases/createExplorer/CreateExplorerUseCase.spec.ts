import { ExplorerRepositoryInMemory } from "@modules/cryptocurrencies/repositories/in-memory/ExplorerRepositoryInMemory";
...
describe("Create a cryptocurrency explorer", () => {
    ...
    it("should create a new explorer profile",
   async () => {
